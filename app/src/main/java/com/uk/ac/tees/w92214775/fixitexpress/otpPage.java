...
public class otpPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gPinView = (Pinview)findViewById(R.id.OTP_pin);
        gVerify = (Button)findViewById(R.id.OTP_verifyBtn);
        gTimer = (TextView)findViewById(R.id.OTP_timer);
    ...
    private void createClientInstance(final String cid, String fb_phone) {
        dataMap.put(COMM.U_PHONE,fb_phone);
        ...
        gUserRef.child(cid).setValue(dataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(otpPage.this, "error at db.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void toEditProfile() {
        Intent toEditProfile = new Intent(otpPage.this,profileRegisterPage.class);
        startActivity(toEditProfile);
        finish();
    }

    private void toHome() {
        Intent toHome = new Intent(otpPage.this,homePage.class);
